...
public static class ApplicationPath
{
    ...
    public static bool CheckInstalled()
    {
        ...
        try
        {
            using Microsoft.Win32.RegistryKey? registryKey = Microsoft.Win32.Registry.LocalMachine.OpenSubKey("SOFTWARE/Microsoft/Windows/CurrentVersion/Uninstall/" + ApplicationValue.ApplicationName);
            if (registryKey != null)
            {
                result = true;
            }
