...
public class RectangleDecimal
{
    ...
    /// コンストラクタ
    /// </summary>
    /// <param name="rectangleDecimal">RectangleDecimal</param>
    public RectangleDecimal(
        RectangleDecimal rectangleDecimal
        )
    {
        X = rectangleDecimal.X;
        Y = rectangleDecimal.Y;
        Width = rectangleDecimal.Width;
        Height = rectangleDecimal.Height;
    }
