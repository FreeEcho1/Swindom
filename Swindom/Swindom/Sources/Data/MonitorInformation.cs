...
public class MonitorInformation
{
        ...
        )
    {
        ...
        System.Drawing.Point centerPositionOfTheWindow = new(rectangle.Left + rectangle.Width / 2, rectangle.Top + rectangle.Height / 2);     // ウィンドウの中央の位置
        ...
        RectangleInt windowRectangle = new(rectangle.Left, rectangle.Top, rectangle.Right - rectangle.Left, rectangle.Bottom - rectangle.Top);        // ウィンドウの位置とサイズ
        foreach (MonitorInfoEx nowMonitorInfo in ApplicationData.MonitorInformation.MonitorInfo)
        {
            ...
            RectangleInt intersectRectangle = RectangleInt.Intersect(monitorRectangle, windowRectangle);     // 交差の値
