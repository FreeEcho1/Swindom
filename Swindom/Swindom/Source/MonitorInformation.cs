namespace Swindom.Source
{
    ...
    public class MonitorInformation
    {
        ...
        /// モニター情報
        /// </summary>
        public System.Collections.Generic.List<MonitorInfoEx> MonitorInfo = new();
        ...
        public static MonitorInformation GetMonitorInformation()
        {
            ...
            NativeMethods.EnumDisplayMonitors(System.IntPtr.Zero, System.IntPtr.Zero, new(MonitorEnumProc), monitorInformation);
        ...
        /// <returns></returns>
        public static int MonitorEnumProc(
