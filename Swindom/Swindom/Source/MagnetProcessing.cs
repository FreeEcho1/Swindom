namespace Swindom.Source
{
    ...
    /// マグネット処理
    /// </summary>
    public class MagnetProcessing : System.IDisposable
    {
        /// <summary>
        /// Disposeが呼ばれたかの値
        /// </summary>
        ...
        /// マウスカーソルのX座標の停止タイマー
        /// </summary>
        private System.Timers.Timer CursorStopXTimer;
        /// <summary>
        /// マウスカーソルのY座標の停止タイマー
        /// </summary>
        private System.Timers.Timer CursorStopYTimer;
        /// <summary>
        /// 初期のマウスカーソルのクリッピング範囲
        /// </summary>
        ...
        /// 前回のマウスカーソルの位置
        /// </summary>
        private System.Drawing.Point PreviousCursorPosition = new();
        /// <summary>
        /// ウィンドウハンドルのリスト
        /// </summary>
        ...
        {
            return (Common.ApplicationData.Settings.MagnetInformation.Enabled
            ...
            )
        {
            try
            {
                ...
                if (HwndList == null && Common.ApplicationData.Settings.MagnetInformation.PasteToAnotherWindow)
                {
                    ...
                    System.IntPtr movingHwnd = NativeMethods.GetForegroundWindow();     // 移動中のウィンドウのハンドル
            ...
            )
        {
            try
            {
                ...
                if (Common.ApplicationData.Settings.MagnetInformation.PressTheKeyToPaste == false
                    || (((System.Windows.Input.Keyboard.GetKeyStates(System.Windows.Input.Key.LeftCtrl) & System.Windows.Input.KeyStates.Down) == System.Windows.Input.KeyStates.Down)
                    || ((System.Windows.Input.Keyboard.GetKeyStates(System.Windows.Input.Key.RightCtrl) & System.Windows.Input.KeyStates.Down) == System.Windows.Input.KeyStates.Down)))
                {
                    ...
                    {
                        PasteToTheEdgeOfScreenProcessing(nowCursorPosition, monitorInformation);
                    }
                    if (Common.ApplicationData.Settings.MagnetInformation.PasteToAnotherWindow)
                    {
                        PasteIntoAnotherWindowProcessing(nowCursorPosition, monitorInformation);
                    }
                }
            ...
            )
        {
            try
            {
                ...
                if (CursorStopYTimer.Enabled == false)
                {
                    ...
                    NativeMethods.ClipCursor((monitorInformation.MonitorInfo.Count == 1) ? CursorClip : null);
                }
            }
            catch
            {
            ...
            )
        {
            try
            {
                System.IntPtr hwnd = NativeMethods.GetForegroundWindow();     // ウィンドウハンドル
            ...
            )
        {
            try
            {
                if (0 < HwndList.Hwnd.Count)
                {
                    ...
                    foreach (System.IntPtr hwnd in HwndList.Hwnd)
                    {
